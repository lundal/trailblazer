app.service('CharacterService', [function() {
    ...
    service.create = function(guid) {
        ...
        character.skills = [
            ...
            {name:'Knowledge (arcana)',      clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (dungeon.)',    clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (engineering)', clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (geography)',   clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (history)',     clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (local)',       clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (nature)',      clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (nobility)',    clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (planes)',      clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
            {name:'Knowledge (religion)',    clas:false, untrained:false, ability:'Int', ranks:0, misc:[{bonus:0, desc:''}]},
